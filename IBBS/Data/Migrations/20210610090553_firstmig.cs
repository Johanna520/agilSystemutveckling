        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avocado = table.Column<int>(type: "int", nullable: false),
                    Bacon = table.Column<int>(type: "int", nullable: false),
                    BottomBunDark = table.Column<int>(type: "int", nullable: false),
                    TopBunDark = table.Column<int>(type: "int", nullable: false),
                    Cheese = table.Column<int>(type: "int", nullable: false),
                    Chicken = table.Column<int>(type: "int", nullable: false),
                    Cucumber = table.Column<int>(type: "int", nullable: false),
                    Hallumi = table.Column<int>(type: "int", nullable: false),
                    ...
                    SalladBunBottom = table.Column<int>(type: "int", nullable: false),
                    SalladBunTop = table.Column<int>(type: "int", nullable: false),
                    TopLightBun = table.Column<int>(type: "int", nullable: false),
                    Sallad = table.Column<int>(type: "int", nullable: false),
                    Tomato = table.Column<int>(type: "int", nullable: false),
                    Beef = table.Column<int>(type: "int", nullable: false),
                    BottomLightBun = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UseIngredient", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UseIngredient_Burgers_SavedHamburgersId",
                        column: x => x.SavedHamburgersId,
                        principalTable: "Burgers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UseIngredient_Ingredients_IngredientsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UseIngredient_SavedHamburgersId",
                table: "UseIngredient",
